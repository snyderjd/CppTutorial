...
int main() {
    ...
    // Note to self: describe what's going to happen in std::strcat before you do the cat:
    // source is going to be appended to dest, and the process will start by overriding the
    // null character in dest
    ...
    // This is a pattern you'll see a lot in C++ code

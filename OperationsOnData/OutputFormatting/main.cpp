...
int main() {
    ...
    std::cout << std::endl;
    // ===============================================
    // Justify - values can be justified in their fields. There are three manipulators - left, right, and internal
    ...
    // ==========================================
    std::cout << "----- showpos and noshowpos  -----" << std::endl;
    ...
    std::cout << std::endl;
    // ==========================================
    std::cout << "----- Different number systems: std::dec, std::hex, std::otc -----" << std::endl;
    ...
    // If the precision is bigger than supported by the type the additional values will be garbage

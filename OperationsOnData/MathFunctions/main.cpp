...
int main() {
    ...
    // log10, 10^4 = 10000, to get 10k, you need to elevate 10 to the power of ?, this is log in base 10
    std::cout << "To get 10,000, you need to elevate 10 to the power of: " << std::log10(10000) << std::endl;

...
int main() {
    ...
    */
    ...
    // p_number4 points to deleted memory, dereferencing it will lead to undefined behavior - crash, garbage, etc
    ...
    */
    ...
    /*
    // Solution 2: Right after you call delete on a pointer, remember to reset the
    // pointer to nullptr to make it CLEAR it doesn't point anywhere
    std::cout << std::endl;
    ...
    */
    ...
    // one clear pointer (master pointer) that owns the memory (responsible for 
    // releasing when necessary), other pointers should only be able to dereference

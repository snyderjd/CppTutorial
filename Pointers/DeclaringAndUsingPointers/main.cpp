...
int main() {
    ...
    // It is better to separate these declarations on different lines so there is no room for confusion
    int *p_number7{};
    // int other_int_var{};
    ...
    // You can also change the address stored in pointer any time
    int int_var1 = 65;
    ...
    std::cout << "value: " << *p_int2 << std::endl; // dereferencing a pointer aka reading the value that the pointer is pointing to

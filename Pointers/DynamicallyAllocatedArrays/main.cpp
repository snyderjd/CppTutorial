...
int main() {
    ...
    // Allocating memory space for an array of size vars. 
    // First 5 will be with 1, 2, 3, 4, 5 and the rest will be 0s
    ...
    // std::size doesn't work, they don't support range-based for loops
